# Restaurant-Ratings-Predictor-App

1. Executive Summary

The Restaurant Rating Predictor App is a machine learning–powered web application that predicts the likely quality or review category of a restaurant based on a small set of business features.
